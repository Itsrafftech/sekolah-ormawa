...
16. `20260908090000_add_ketua_pelaksana_role` ("Tambah Role Baru dan 2 Akun" - ADR-049, menambah role `KETUA_PELAKSANA` ke `users_role_department_scope_check`)
17. `20260908100000_senbud_supplemental_fields` ("Tambahan Field Khusus Senbud" - ADR-050, tambah kolom `CandidateSupplementalData.senbudPortfolioUrl` dan enum value `UploadKind.SENBUD_INSTAGRAM`)
18. `20260908110000_ristek_portfolio_url` ("Tambahan Field Khusus Ristek" - ADR-051, tambah kolom `CandidateSupplementalData.ristekPortfolioUrl`)
