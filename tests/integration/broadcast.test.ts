...
async function insertCandidate(id: string, departmentId: string): Promise<void> {
  ...
  await pool.query(
    `INSERT INTO candidates
     ...
     VALUES ($1, $2, $3, 'Kandidat Broadcast Fixture', $4, $4, 63, 2026, 'Kelas B7', $5, '081200000001', $6, $6, 'Kota Fixture', 'Sintetis', 'Sintetis', 'Sintetis', 'SUBMITTED', now(), now(), 'EXECUTIVE', $7, $8)`,
