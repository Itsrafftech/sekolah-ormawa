...
test.beforeAll(async () => {
  ...
  await pool.query(
    `INSERT INTO candidates
     ...
     VALUES ($1, $2, 'REG-A11Y01', 'Kandidat Aksesibilitas', 'NIM-A11Y01', 'NIM-A11Y01', 63, 2026, 'Kelas AX', $3, '081200000002', 'a11y-candidate@example.test', 'a11y-candidate@example.test', 'Kota Fixture', 'Sintetis', 'Sintetis', 'Sintetis', 'SUBMITTED', now(), now())
